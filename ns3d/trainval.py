...
parser.add_argument('--object_data_path', required=True, metavar='DIR', help="data directory")
...
def main():
    ...
    data_loaders = make_data_loaders(referit3d_args, referit_data, vocab, class_to_idx, all_scans_in_dict, mean_rgb, args.object_data_path)
