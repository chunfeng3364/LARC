...
class ReferIt3DDefinition(DatasetDefinitionBase):
    def __init__(self):
        ...
        self.excl_concept = ['on','left', 'right', 'front', 'behind', 'above', 'below', 'over', 'under', 'beneath', 'underneath', 'lying', 'back', 'top', 'supporting','with']
        self.sym_concept = ['beside', 'next', 'near', 'close', 'closer', 'closest', 'far', 'farthest']
...
referir3ddefination = ReferIt3DDefinition()