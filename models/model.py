...
from datasets.referit3d.definition import referir3ddefination
...
class NS3DReferIt3DModelBase(nn.Module):
    ...
    def __init__(self):
        ...
        self.excl_concept = referir3ddefination.excl_concept
        self.sym_concept = referir3ddefination.sym_concept
...
class NS3DReferIt3DModel(NS3DReferIt3DModelBase):
    def __init__(self, **kwargs):
        ...
        from models.modules.referit3d_reasoning import SceneConceptLoss, RefExpLoss, Regularization
